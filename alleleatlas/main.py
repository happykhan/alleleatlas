...
def _read_file_start(cgmlst_profiles, nlines=10):
    """
...
def adjust_input_type(cgmlst_profiles, remap_alleles=False):
    """
    ...
    Returns (df, st_counts_dict)
    """
    st_counts_dict = None
    df = _read_file_start(cgmlst_profiles, nlines=10)
    if df.shape[0] == 0:
    ...
    if input_type == 'matrix':
        ...
        df = _read_file_start(cgmlst_profiles, nlines=-1)
